;(function ($) {
  ...
  audioElement.setAttribute('src', 'img/bwob/bebop.mp3')
  ...
  var siteHeader = $('.site-header'),
    ...
    scrollSmoother,
    $cursorInner =
      ' <div class="mouse-cursor-icon"></div><svg height="100%" width="100%" viewbox="0 0 100 100"><circle class="main-circle" cx="50" cy="50" r="40" /></svg><span class="mouse-cursor-text"></span>'
  ...
  function naylaMouseCursor(init) {
    ...
    if (mouseCursor.length) {
      ...
      defaultHover(
        'a , .menu-toggle, .rotate-text-area , .project-slide-button, button, .hover-classic, .cv-toggle,  .scroll-button'
      )
  ...
  function pageLoader() {
    if ($('.page-loader').length) {
      ...
      countLabels.forEach((element) =>
        $('.page-loader-count').append('<span class="count_' + element + '">' + element + '</span>')
      )
            ...
            tl.to(
              perc,
              {
                y:
                  -1 *
                  (calcWin -
                    (calcWin != 0 ? perc.outerHeight() : 0) -
                    (calcWin == $(window).outerHeight() ? spacing : 0)),
                duration: 1,
                ease: 'expo.inOut',
              },
              'label_' + snapPerc
  ...
  function siteNavigation() {
    ...
    function classicNavigation() {
      ...
      var resetHeader = gsap.delayedCall(0.7, headerLayoutChange, [false, false, false, true])
      resetHeader.kill()
      ...
      setTimeout(function () {
        hasChild.each(function (i) {
          ...
          $this
            .find('.nayla-sub-menu-wrap')
            .addClass('sub_' + i)
            .insertBefore(siteHeader)
    ...
    function fullscreenNavigation() {
      ...
      if (nav.length) {
        ...
        hasChildren.children('.sub-toggle').on('click', function () {
          ...
          gsap.delayedCall(0.5, menuItemAnims, [subMenu, 'in'])
        })
        ...
        subClose.on('click', function () {
          ...
          gsap.delayedCall(0.5, menuItemAnims, [inMenu, 'in'])
  ...
  class naylaGeneralAnimations {
    ...
    constructor(DOM_el, options, fromOptions, scroll, out) {
      ...
      this.target == null
        ...
        : (this.scroll.scrollTrigger.trigger = $(this.target))
      ...
      if (activeAnimation[0] === 'scaleIn') {
        this.target.attr('data-start') == null
          ? (this.from.scale = 0)
          : (this.from.scale = this.target.attr('data-start'))
      ...
      if (
        activeAnimation[0] === 'maskUp' ||
        activeAnimation[0] === 'maskDown' ||
        activeAnimation[0] === 'maskLeft' ||
        activeAnimation[0] === 'maskRight' ||
        activeAnimation[0] === 'maskCustom'
      ) {
  ...
  function naylaTextAnims() {
    ...
    hasAnim.not(exclude).each(function () {
      ...
      if ($this.hasClass('wordsJustifyCollapse') || $this.hasClass('wordsJustifyExpand')) {
        ...
        $this.hasClass('wordsJustifyExpand')
          ? $this.css('textAlignLast', 'justify')
          : $this.css('textAlignLast', 'auto')
  ...
  function naylaProjectPages() {
    ...
    if (header.hasClass('image-gallery')) {
      ...
      if (horizontal) {
        ...
        tl.to(
          header.find('.project-category, .project-meta, .project-slide-button'),
          {
            opacity: 0,
          },
          0
    ...
    portfolio.each(function () {
      ...
      function createSeperators(lengths) {
        ...
        if (!portfolio.hasClass('masonry')) {
          ...
          for (i = 1; i < lengths; i++) {
            i % columns == 0
              ? $(line).insertAfter(projectsWrapper.find('.grid-project:visible[data-current-index="' + i + '"]'))
              : ''
          }
        }
      }
      ...
      switchList.on('click', () => {
        ...
        gsap.to(projects, {
          ...
          onComplete: () => {
            ...
            $('<span class="g-list-arrow material-icons">arrow_outward</span>').insertBefore(
              projects.find('.grid-project-wrap .grid-project-meta > div:last-child')
            )
  ...
  function showcase3dTitles() {
    ...
    showcase3dTitles.each(function () {
      ...
      window.addEventListener('scroll', function () {
        ...
        $this
          .find('.active-title_' + activeIndex)
          .nextAll()
          .removeClass('active')
        $this
          .find('.active-title_' + activeIndex)
  ...
  function showcaseList() {
    ...
    sflWrap.each(function () {
      ...
      if ($this.hasClass('animate-in')) {
        ...
        $this.find('.project-title').attr('data-delay', 0.5)
      }
    })
  }
  ...
  function showcaseFullscreenSlideshow() {
    ...
    fullscreenSlideshow.each(function () {
      ...
      projects.each(function (i) {
        ...
        image
          .addClass('swiper-slide image_' + i)
          .wrapInner('<div class="fs-parallax-wrap"><div class="slide-bgimg"></div></div>')
          .appendTo(images.find('.swiper-wrapper'))
      })
        ...
        imagesSwiper = new Swiper('.fs-images-slider', {
          ...
          on: {
            ...
            slideChangeTransitionEnd: function () {
              ...
              current.html(
                $('.showcase-project.active').data('index') < 10
                  ? '0' + ($('.showcase-project.active').data('index') + 1)
                  : $('.showcase-project.active').data('index') + 1
              )
      ...
      if (fsSlideshow.hasClass('animate-in')) {
        ...
        tl.fromTo(
          fsSlideshow.find('.fs-images-slider'),
          {
        ...
        tl.fromTo(
          fsSlideshow.find('.project_0 .pt_char span, .project-button a'),
          {
            x: 100,
          },
          {
        ...
        tl.fromTo(
          fsSlideshow.find('.showcase-footer'),
          {
            y: 100,
          },
          {
  ...
  function showcaseFullscreenCarousel() {
    ...
    showcaseFullscreenCarousel.each(function (i) {
      ...
      projects.each(function (i) {
        ...
        image
          .addClass('swiper-slide s-img_' + i)
          .wrapInner('<div class="fs-parallax-wrap"><div class="slide-bgimg"></div></div>')
          .appendTo(imagesWrap.find('.swiper-wrapper'))
          ...
          on: {
            slideChange: function () {
              ...
              if (colorAnim == true) {
                ...
                $('.s-img_' + this.activeIndex)
                  .find('.fs-parallax-wrap')
                  .addClass('transition--media')
        ...
        let $this = $(this),
          ...
          top =
            $this.offset().top > $(window).outerHeight() / 2
              ? $this.offset().top + $(window).outerHeight() / 4
              : $this.offset().top,
          title = $this.find('.project-title'),
  ...
  function horizontalList() {
    $('.showcase-horizontal-list').each(function () {
      ...
      projects.each(function (i) {
        ...
        $this.attr('data-index', i)
        image
          .wrapInner('<div class="image-wrap"></div>')
          .addClass('project_image_' + i)
          .appendTo(imagesWrap)
  ...
  var switchedDark, switchedLight
  ...
  function layoutSwitcher() {
    ...
    if (switcher.hasClass('ls_switcher')) {
      ...
      switchDark.on('click', function () {
        ...
        if (
          !$('.project-page-header.half-image').length &&
          !$('.project-page-header.fullscreen-image').length &&
          !$('.project-page-header.tall-image').length
        ) {
          if (!siteHeader.hasClass('blend')) {
    ...
    grid.each(function () {
      ...
      items.each(function (i) {
        ...
        if (animation != null) {
          ...
          grid.attr('data-stagger') < 0
            ? (stg = -1 * (grid.attr('data-stagger') / i))
            : (stg = grid.attr('data-stagger') * i)
    ...
    carousel.each(function () {
      ...
      items.each(function (i) {
        ...
        if (animation != null) {
          ...
          carousel.attr('data-stagger') < 0
            ? (stg = -1 * (carousel.attr('data-stagger') / i))
            : (stg = carousel.attr('data-stagger') * i)
  ...
  function circleMaskBg() {
    $('.circle-mask-background').each(function () {
      ...
      $this.append(
        '<svg class="mask-bg" width="100%" height="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" ><defs><filter id="displacementFilter"><feTurbulence type="fractalNoise" baseFrequency="0.03" numOctaves="3" result="noise" /><feDisplacementMap in="SourceGraphic" in2="noise" scale="50" xChannelSelector="R" yChannelSelector="G" /></filter><mask id="circleMask"><circle cx="50%" cy="50%" r="00" fill="white" class="mask" style="filter: url(#displacementFilter);" /></mask></defs><image xlink:href="' +
          url +
          '" x=0 y=0 width="100%" mask="url(#circleMask)" /></svg>'
      )
      ...
      video.each(function (i) {
        ...
        naylaVid.on('ready', (event) => {
          ...
          vid
            ...
            .append(
              '<span class="hover-default nayla-player-control nayla-play">' +
                playText +
                '</span><span class="hover-default nayla-player-control nayla-pause">' +
                pauseText +
                '</span>'
            )

          vid
            .find('.plyr__controls__item.plyr__volume button[data-plyr="mute"]')
            .append(
              '<span class="hover-default nayla-player-control nayla-mute">' +
                muteText +
                '</span><span class="hover-default nayla-player-control nayla-unmute">' +
                unmuteText +
                '</span>'
            )
        ...
        if ($this.next().length) {
          tl.to(
            $this.next(),
            {
              ...
              onStart: () => {
                current.html(
                  $this.next().data('index') + 1 > 10
                    ? $this.next().data('index') + 1
                    : '0' + ($this.next().data('index') + 1)
                )
              },
            },
            'label' + i
  ...
  transitions.hasClass('up')
    ? (up = true)
    : transitions.hasClass('down')
    ? (down = true)
    : transitions.hasClass('left')
    ? (left = true)
    : transitions.hasClass('right')
    ? (right = true)
    : ''

  transitions.hasClass('block')
    ? (block = true)
    : transitions.hasClass('overlay')
    ? (overlay = true)
    : transitions.hasClass('opacity')
    ? (opacity = true)
    : transitions.hasClass('page-over')
    ? (pageOver = true)
    : transitions.hasClass('columns')
    ? (columns = true)
    : ''
  ...
  function animateOverlay(time, intro, outro) {
    if (intro) {
      time.to(
        transitions.find('.transition-overlay'),
        {
          height: '100%',
          width: '100%',
          duration: 1,
  ...
  function fullscreenCarouselOut(tl) {
    ...
    tl.to(
      [slides, '.sfc-fraction', '.showcase-footer', '.project-button'],
      {
        opacity: 0,
      },
      0
  ...
  function fullscreenSlideshowOut(tl) {
    ...
    tl.to(
      [active.find('.pt_char'), active.find('.pd_word span')],
      {
        yPercent: -100,
        duration: 0.75,
        ease: 'expo.in',
  ...
  function showcaseListOut(tl) {
    tl.to(
      '.sfl-projects .project-title, .sfl-projects .project-meta',
      {
        yPercent: -100,
        opacity: 0,
      },
  ...
  function fullscreenWallOut(tl) {
    ...
    tl.to(
      '.project-title, .project-category, .showcase-footer',
      {
        opacity: 0,
        duration: 1,
        ease: 'expo.in',
  ...
  function showcase3dTitlesOut(tl) {
    ...
    tl.to(
      '.s3t-projects-wrap .project-title',
      {
        y: -200,
        duration: 1,
        ease: 'expo.in',
  ...
  function projectImageEnter(tl, response, targetBg) {
    ...
    if (mobileQuery.matches) {
      let top =
        image.offset().top -
        $('main').first().outerHeight() -
        $('main').first().offset().top -
        (transImage.data('margins') != null ? transImage.data('margins') : 0)
    }
    ...
    transitions: [
      {
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            block
              ? animateBlocks(tl, true, false)
              : overlay
              ? animateOverlay(tl, true, false)
              : opacity
              ? animateOpacity(tl, true, false)
              : pageOver
              ? animatePageOver(tl, true, false)
              : columns
              ? animateColumns(tl, true, false)
              : ''
        ...
        beforeEnter() {
          return new Promise(function (resolve, reject) {
            ...
            block
              ? animateBlocks(tl, false, true)
              : overlay
              ? animateOverlay(tl, false, true)
              : opacity
              ? animateOpacity(tl, false, true)
              : pageOver
              ? animatePageOver(tl, false, true)
              : columns
              ? animateColumns(tl, false, true)
              : ''
      ...
      },
      {
        ...
        to: {
          namespace: [
            'project-half-image',
            'project-image-gallery-horizontal',
            'project-no-image',
            'project-image-gallery-vertical',
            'project-video',
            'project-creative',
            'project-boxed-image',
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            if (
              $('div.showcase-carousel').length ||
              $('div.showcase-fullscreen-carousel').length ||
              $('div.showcase-fullscreen-slideshow').length ||
              $('div.showcase-3d-titles').length ||
              $('div.showcase-cards').length
            ) {
            } else {
            ...
            $('div.showcase-cards').length
              ? showcaseCardsOut(tl)
              : $('div.showcase-carousel').length
              ? outAnimShowcaseCarousel(tl)
              : $('div.showcase-fullscreen-carousel').length
              ? fullscreenCarouselOut(tl)
              : $('div.showcase-fullscreen-slideshow').length
              ? fullscreenSlideshowOut(tl)
              : $('div.showcase-minimal-list').length
              ? minimalListOut(tl)
              : $('div.showcase-fullscreen-wall').length
              ? fullscreenWallOut(tl)
              : $('div.showcase-list').length
              ? showcaseListOut(tl)
              : $('div.showcase-3d-titles').length
      ...
      },
      {
        ...
        leave(trigger) {
          return new Promise(function (resolve, reject) {
            ...
            if ($('body').hasClass('smooth-scroll')) {
              let aliothSmoother = ScrollSmoother.get()
              aliothSmoother.scrollTo(
                media.offset().top -
                  ($(window).outerHeight() - media.outerHeight()) +
                  ($(window).outerHeight() - media.outerHeight()) / 2,
                2
              )
            } else {
              target = window
              ...
              onComplete: () => {
                ...
                if (media.find('.n-vimeo').length || media.find('.n-youtube').length) {
                  ...
                  $('body').hasClass('smooth-scroll')
                    ? media.insertBefore('#smooth-content')
                    : media.insertBefore('main')
            ...
            if (media.find('.nayla-video').length) {
              tl.to(
                [otherProj, '.grid-controls', lastTar],
                {
                  opacity: 0,
                },
                0
              ...
              tl.to(
                [otherProj, media.parent('div').find('.masked'), '.grid-controls', lastTar],
                {
                  opacity: 0,
                },
                0
          ...
          return new Promise(function (resolve, reject) {
            ...
            let image = response.find('.project-page-header .project-image.featured'),
              top =
                image.offset().top -
                $('main').first().outerHeight() -
                $('main').first().find('.project-page').outerHeight(),
              height = image.outerHeight(),
              width = image.outerWidth(),
              left = image.offset().left,
              transImage = $('.animating')
  ...
  $(document).ready(function () {
    $('.inner-project-link, .next-project-link, .grid-project-link, .menu-link, .sc-link, .showcase-project-link').on(
      'click',
      () => {
        //            startLoading()
      }
    ...
    setTimeout(function () {
      ...
      gsap.set(
        [
          siteHeader,
          stickyTargets,
          siteHeader.children('div'),
          siteHeader.find('.site-logo'),
          siteHeader.find('.sticky-logo'),
        ],
        {
          clearProps: 'all',
        }
  ...
  $(document).ready(function () {
    $.getJSON('./package.json', function (jd) {
